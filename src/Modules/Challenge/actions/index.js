...
export const fetchChallengeSuccess = payload => ({ type: FETCH_CHALLENGE_SUCCESS, payload })

export const updateChallengeRequest = () => ({ type: UPDATE_CHALLENGE_REQUEST })
export const updateChallengeSuccess = payload => ({ type: UPDATE_CHALLENGE_SUCCESS, payload })
