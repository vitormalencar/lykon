    ...
    return (
      <div>
        <div className='full-width'>
          <img src={attributes.extra.image || PLACEHOLDER} className='full-image' alt='card' />
        </div>
        <br />
        ...
        <div className='content'>
          ...
          {attributes.complete
            ? <h3>Well done ! you have completed this challenge <span role="img" aria-label='tada'>🎉</span> </h3>
