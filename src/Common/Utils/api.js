...
const getRequest = (path) => fetch(`${BASE_URL}/${path}`).then(res => res.json())

const putRequest = (path, payload) => fetch(`${BASE_URL}/${path}`, {
  method: 'PUT',
...
export const updateChallenge = (id, payload) => putRequest(`challenges/${id}`, payload)
